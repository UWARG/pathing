...
def diversion_qr_to_waypoint_list(qr_text: str) -> "tuple[list[Waypoint], Waypoint] | None":
    """
    ...
    tuple[list[Waypoint], Waypoint]] | None
        Returns None if the string is invalid or if the list is empty.
    """
    ...
    if len(rejoin_waypoint) == 0:
        return None
    
    return (diversion_waypoints, rejoin_waypoint)