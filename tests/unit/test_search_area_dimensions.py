...
def test_no_field_of_view() -> None:
    ...
    x, y = search_area_dimensions.search_area_dimensions(height, frustum_angle_x, frustum_angle_y, True, field_of_vision_x, field_of_vision_y, True)
...
def test_askew_acute_field_of_view() -> None:
    ...
    x, y = search_area_dimensions.search_area_dimensions(height, frustum_angle_x, frustum_angle_y, True, field_of_vision_x, field_of_vision_y,
                                  True)
